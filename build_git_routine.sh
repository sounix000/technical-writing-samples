...
asciidoctor -r asciidoctor-pdf -b -o ./build/pdf/exercises/findNeedles.pdf ./src/findNeedles.adoc
asciidoctor -r asciidoctor-pdf -b -o ./build/pdf/RESTvsSOAP.pdf ./src/RESTvsSOAP.adoc
asciidoctor -r asciidoctor-pdf -b -o ./build/pdf/exercises/TicTacToe.pdf ./src/TicTacToe.adoc
